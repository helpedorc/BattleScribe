...
class OrksActivity : AppCompatActivity() {

    private lateinit var addBoyz: Button
    private lateinit var minusBoyz: Button
    ...
    private lateinit var addGoblin: Button
    private lateinit var minusGoblin: Button
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        numPuntiS.text = contatoreGoblin.toString()
        numPoint.text = punti.toString()

        addBoyz.setOnClickListener() {
            contatoreRobot += 3
            numPuntiB.text = contatoreRobot.toString()
            punti += 200
            numPoint.text = punti.toString()
        ...
        minusGoblin.setOnClickListener() {
            contatoreGoblin -= 5
            numPuntiS.text = contatoreGoblin.toString()
            if (contatoreGoblin < 0) {
                contatoreGoblin = 0
                numPuntiS.text = contatoreGoblin.toString()
            }
            if (contatoreGoblin == 0) {
                punti -= 0
                numPoint.text = contatoreGoblin.toString()
            } else {
                punti -= 50
            }
            if (punti < 0) {
    ...
    private fun initialize() {
        addBoyz = findViewById(R.id.Plus2)
        minusBoyz = findViewById(R.id.Minus2)
        ...
        addGoblin = findViewById(R.id.Plus4)
        minusGoblin = findViewById(R.id.Minus4)
